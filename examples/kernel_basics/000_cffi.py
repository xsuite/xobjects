...
x1_cffi = ffi_interface.cast('double *', ffi_interface.from_buffer(x1))
x2_cffi = ffi_interface.cast('double *', ffi_interface.from_buffer(x2))
y_cffi = ffi_interface.cast('double *', ffi_interface.from_buffer(y))
