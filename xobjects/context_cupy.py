...
if _enabled:
    ...
    class LinkedArrayCupy(BaseLinkedArray, cupy.ndarray):
        ...
        def __ifloordiv__(self, other):
            self = self.__floordiv__(self, other)

        def __ilshift__(self, other):
            self = self.__lshift__(self, other)

        def __imatmul__(self, other):
            self = self.__matmul__(self, other)

        def __imod__(self, other):
            self = self.__mod__(self, other)

        def __imul__(self, other):
            self = self.__mul__(self, other)

        def __ipow__(self, other):
            self = self.__pow__(self, other)

        def __irshift__(self, other):
            self = self.__rshift__(self, other)

        def __isub__(self, other):
            self = self.__sub__(self, other)

        def __itruediv__(self, other):
            self = self.__truediv__(self, other)

        def __ixor__(self, other):
            self = self.__xor__(self, other)
